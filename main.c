...
int main()
{
    double capital, tasaInteres, tiempo, monto, interes, capitalizaciones, valorPresente, terminoRenta;     // Definir variables
    char entrada[256];                                                                                      // String para almacenar la entrada
    char modo;                                                                                              // Caracter para el modo de cálculo
    printf("Que tipo de interes quieres calcular? (s)imple, (c)ompuesto, (t)asa nominal, (a)mortizacion "); // Preguntar lo que se quiere calcular
